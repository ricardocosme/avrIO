** avrIO [[https://github.com/ricardocosme/avrIO/actions?query=workflow%3A%22avr-gcc+10.2%22][https://github.com/ricardocosme/avrIO/workflows/avr-gcc%2010.2/badge.svg?branch=main]]
...
This library can be useful in the application layer delivering an expressive code(see [[file:demo/c++11/led.cpp][demo/c++11/led.cpp]]) but it can also be used to develop flexible and concise APIs(see [[file:demo/c++20/api.cpp][demo/c++20/api.cpp]]).
...
2. Adjust at least the variables ~MCU~ and ~AVRDUDE_DEVICE~ in the ~Makefile~ to the appropriate values related to your microcontroller. /Note, the demos are already ready to ATtiny85./
3. ~make~
...
**** [[https://github.com/ricardocosme/ds18b20][ds18b20]]
